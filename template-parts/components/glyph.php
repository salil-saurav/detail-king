...
$paths = [
   ...
   'truck'   => '<path d="M2 5h11v9H2V5zm11 3h3.6L20 11.2V14h-4V8zM5.5 19a1.8 1.8 0 1 0 0-3.6 1.8 1.8 0 0 0 0 3.6zm11 0a1.8 1.8 0 1 0 0-3.6 1.8 1.8 0 0 0 0 3.6z"/>',
   'clock'   => '<path d="M12 2.4A9.6 9.6 0 1 0 21.6 12 9.6 9.6 0 0 0 12 2.4zm0 2.2a7.4 7.4 0 1 1 0 14.8 7.4 7.4 0 0 1 0-14.8z"/><path d="M12.9 7.5h-1.8v5l4.3 2.6.9-1.5-3.4-2z"/>',
   'headset' => '<path d="M12 2.6a8 8 0 0 0-8 8v5.4A2.9 2.9 0 0 0 6.9 19H8v-6.4H5.7V10.6a6.3 6.3 0 0 1 12.6 0v2H16V19h1.1a2.9 2.9 0 0 0 2.9-2.9V10.6a8 8 0 0 0-8-8z"/>',
];
