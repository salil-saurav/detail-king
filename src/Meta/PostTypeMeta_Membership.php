...
class PostTypeMeta_Membership extends AbstractPostTypeMeta
{
   ...
   protected function fields(): array
   {
      return [
         ...
         $this->field('plan_product', __('Linked Product', 'detailking'), 'post_object', [
            'post_type'     => ['product'],
            'return_format' => 'id',
            'allow_null'    => 1,
            'multiple'      => 0,
            'ui'            => 1,
            'readonly'      => 1,
            'instructions'  => __('Flat monthly price, no variation — no subscriptions plugin is installed. PLACEHOLDER PRICING, not client-confirmed. Auto-generated by seed/membership-products.php — do not edit by hand.', 'detailking'),
         ]),
      ];
   }
}
